...
const STEPS = [
  ...
  { key: "brand", title: "Marca", subtitle: "Identidad, historia y forma de comunicar", fields: [
    ...
    { name: "language", label: "Idioma y variante", placeholder: "Español neutro (Latinos EE. UU.)" },
