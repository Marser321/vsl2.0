...
export default function IntakesPage() {
  ...
  async function load() { const [a, b] = await Promise.all([fetch("/api/intakes"), fetch("/api/clients")]); setRows(await a.json()); setClients(await b.json()); }
  useEffect(() => { load(); }, []);
